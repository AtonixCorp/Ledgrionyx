...
variable "main_cidr" { type = string; default = "10.30.0.0/24" }
variable "backend_cidr" { type = string; default = "10.30.1.0/24" }
...
variable "api_flavor" { type = string; default = "m1.large" }
variable "db_flavor" { type = string; default = "m1.xlarge" }
variable "ledger_instance_count" { type = number; default = 2 }
variable "accounts_instance_count" { type = number; default = 2 }
variable "ledger_volume_size_gb" { type = number; default = 100 }
variable "db_volume_size_gb" { type = number; default = 200 }
