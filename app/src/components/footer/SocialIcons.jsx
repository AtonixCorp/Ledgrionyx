...
const socialLinks = [
  {
    label: 'LinkedIn',
    href: 'https://www.linkedin.com/company/atonixcapital',
    icon: (
  ...
  {
    label: 'Facebook',
    href: 'https://www.facebook.com/atonixcapital',
    icon: (
      <svg viewBox="0 0 24 24" aria-hidden="true">
  ...
  {
    label: 'X',
    href: 'https://x.com/atonixcapital',
    icon: (
      <svg viewBox="0 0 24 24" aria-hidden="true">
  ...
  {
    label: 'Instagram',
    href: 'https://www.instagram.com/atonixcapital',
    icon: (
      <svg viewBox="0 0 24 24" aria-hidden="true">
